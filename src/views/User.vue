<template>
  <div class="container py-5">
    ...
    <UserProfileCard
      ...
      @handle-follow-click="handleFollowClick" 
      @handle-unfollow-click="handleUnfollowClick"
    />
    ...
    <div class="row">
      <div class="col-md-4">
        <!-- UserFollowingsCard -->
        <UserFollowingsCard 
          :user="user" :followingsLength="followingsLength"
        />

        <!-- UserFollowersCard -->
        <UserFollowersCard :user="user" :followersLength="followersLength" />
      </div>
      <div class="col-md-8">
        <!-- UserCommentsCard -->
        <UserCommentsCard :user="user" :commentsLength="commentsLength" />

        <!-- UserFavoritedRestaurantsCard -->
        <UserFavoritedRestaurantsCard :user="user" :favoritedRestaurantsLength="favoritedRestaurantsLength" />
      </div>
    </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    fetchUser() {
      ...
      this.followingsLength = Followings.length
      this.followersLength = Followers.length
      this.commentsLength = Comments.length
      this.favoritedRestaurantsLength = FavoritedRestaurants.length
